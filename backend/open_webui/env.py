...
USE_CUDA = os.environ.get("USE_CUDA_DOCKER", "true") #changed to USE_CUDA_DOCKER
...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Eriteach AI lab")
WEBUI_FAVICON_URL = os.environ.get("WEBUI_FAVICON_URL", "https://eriteach.com/favicon.png")
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("eriteach-ai-lab")}
else:
    try:
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "eriteach-ai-lab")
